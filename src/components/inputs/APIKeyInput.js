    ...
    render () {
        ...
        return (
            <div className="APIKeyInput mb-2">
                <label htmlFor={inputId}>Please enter your API key below. (You can find it <a target={"_blank"} href={"https://www.wanikani.com/settings/account#public-api-key"}>here</a>. Please use the &quot;<strong>API Version 1</strong>&quot; key.)</label><br />
